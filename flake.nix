{
  ...
  outputs = {
    ...
    importPkgs = system: self.lib.mkPkgs {inherit system nixpkgs;};
  in
    flake-parts.lib.mkFlake {inherit inputs;} {
      ...
      flake = {
            ...
            nixpkgs.legacyPackages.${system}.applyPatches {
              ...
              patches = [
                ...
                (builtins.fetchurl {
                  ...
                  url = "https://github.com/NixOS/nixpkgs/compare/1dac7c94f3a2dd61d2f17a14323fbbe1dbcdecbc~...1c229bf6f394e65227854061b7d7e5ffa7753ae5.patch?full_index=1";
                  sha256 = "sha256:1kpan12j7w1l53nik5a0imvxlsgdnnvcxk1dkhzd51ividvfcfdq";
                })
              ];
            };
        ...
        in {
          sirius-lee = let
            system = "x86_64-linux";
            nixpkgs' = self.lib.mkNixpkgs {inherit system nixpkgs;};

...
in
  stdenv.mkDerivation (finalAttrs: {
    pname = "shipwright";
    version = "9.1.1-unstable-2025-12-03";

    src = fetchFromGitHub {
      owner = "HarbourMasters";
      repo = "shipwright";
      rev = "9401d4fd712cc4b99537b37940881e9e1a7f61b6";
      hash = "sha256-l0pwghvo+ppGmu0zawaYQGLm0+iPH++a/VRlZ3qPg3Q=";
    ...
    patches = [
      ...
      (fetchpatch {
        ...
        url = "https://github.com/Sirius902/Shipwright/commit/420fc9c211e2f9fc0ac93d4d95303bdb75397413.patch";
        hash = "sha256-jNNhcvndrovpOjadidpGJYp6gvMYZwjiakDI+sTWcGY=";
      })
    ];

...
in
  stdenv.mkDerivation (finalAttrs: {
    pname = "shipwright";
    version = "9.1.1-unstable-2025-12-27";

    src = fetchFromGitHub {
      owner = "HarbourMasters";
      repo = "shipwright";
      rev = "f273ea4294717679847722a0c4024137be6b4ba8";
      hash = "sha256-EnN5P/LB1EKFbU7xeRoCz1bvIE73TjsCmbBm/gE4p6I=";
    ...
    patches = [
      ...
      (fetchpatch {
        ...
        url = "https://github.com/Sirius902/Shipwright/commit/4dfa31e9c3b6bbc5a555042803dc505e71b76447.patch";
        hash = "sha256-n+4j7D3BaATeGhRD5mMIfL/tWjiZQKhoPLj9Zaf7hLw=";
      })
    ];

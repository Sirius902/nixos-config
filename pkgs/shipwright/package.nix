...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-y0Dlddlwonvq7XdtkskqKtgZLFfL9uH4xouNDbuut4Q=";
    ...
    postInstall =
      ...
      + lib.optionalString stdenv.hostPlatform.isDarwin ''
        ...
        cp ${gamecontrollerdb}/gamecontrollerdb.txt $out/Applications/soh.app/Contents/Resources/gamecontrollerdb.txt

...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitHub {
      owner = "aMannus";
      repo = "shipwright";
      rev = "956188e7a5467897a6fdd87807ce0e0d902102fc";
      hash = "sha256-m8iVhfDTptCcuwYEDHHq9qdHNJEsIm3tSJM6jzZTlfY=";
    ...
    postInstall =
      ...
      + lib.optionalString stdenv.hostPlatform.isDarwin ''
        ...
        cp ${sdl_gamecontrollerdb}/share/gamecontrollerdb.txt $out/Applications/soh-ap.app/Contents/Resources/gamecontrollerdb.txt

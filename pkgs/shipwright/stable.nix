  ...
  stdenv.mkDerivation (finalAttrs: {
    ...
    cmakeFlags =
      [
        ...
        (lib.cmakeFeature "CMAKE_INSTALL_PREFIX" "${placeholder "out"}/share/shipwright-stable")
    ...
    postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
      wrapProgram $out/share/shipwright-stable/soh.elf --prefix PATH ":" ${lib.makeBinPath [zenity]}
    '';

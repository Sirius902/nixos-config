...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    version = "2.0.1-unstable-2025-10-15";

    src = fetchFromGitHub {
      owner = "harbourmasters";
      repo = "2ship2harkinian";
      rev = "cc88b5aa0578ea0261780fec90cfb86afc4f1ef2";
      hash = "sha256-FZNZNxVg6YfYOWMvNJwCw89MYGUkXz8JGaTy34wj+v4=";
    ...
    postInstall =
      ...
      + lib.optionalString stdenv.hostPlatform.isDarwin ''
        ...
        cp ${sdl_gamecontrollerdb}/share/gamecontrollerdb.txt $out/Applications/2s2h.app/Contents/Resources/gamecontrollerdb.txt

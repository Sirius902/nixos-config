{inputs}: [
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-08";

      src = prevAttrs.src.override {
        tag = null;
        rev = "aa18760e5e61ccb786ae03893b79f345f69b8365";
        hash = "sha256-sSHMYpwA6nDDj/oRfGcyuLibMGXAjrOL/Ao5FZjeSvg=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "6de526c684ee6dd8b6fc3447dae858ae480ccbb5";
        hash = "sha256-6UoGiqOwmMt1isjgUe7omPEbEeGfYWDnHZEW6ar30/0=";

        leaveDotGit = false;
        postFetch = ''
          echo 6de526c684ee6dd8b6fc3447dae858ae480ccbb5 > $out/COMMIT
        '';
      };

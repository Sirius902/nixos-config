{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-01";
      src = prevAttrs.src.override {
        tag = null;
        rev = "f113e7bb9380555c64b3031ad17e64c3ca85e2c8";
        hash = "sha256-OcgHo8vffxh2CvQHjPvtaITe5ep3vjXpHPJZane2NOE=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-08-01";

      src = prevAttrs.src.override {
        tag = null;
        rev = "5c6dcce721ee3fe3814d41aaa3e2e55f07a821e7";
        hash = "sha256-Y3iE9nVEzMXOARVWY6O/HPZucpsK2HAJtfHvZkQRtlI=";

        leaveDotGit = false;
        postFetch = ''
          echo 5c6dcce721ee3fe3814d41aaa3e2e55f07a821e7 > $out/COMMIT
        '';
      };

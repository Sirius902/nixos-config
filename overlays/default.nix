{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-09-10";
      src = prevAttrs.src.override {
        tag = null;
        rev = "028d1e8f4a42df2292cdbcd35e540c9e71fc47aa";
        hash = "sha256-ePI/DmC9qdTYfBm28aR4epCAdunEVKRH20ObKSV1zU4=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-10";

      src = prevAttrs.src.override {
        tag = null;
        rev = "7a8caf12b60133a3303acef31b055c1d0ebe08c5";
        hash = "sha256-jv2B0DgxYSXLeY9dHuZFuZK8+t1YQ5HA4RjB/gJvDU8=";

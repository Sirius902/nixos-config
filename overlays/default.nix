{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-06-13";
      src = prevAttrs.src.override {
        tag = null;
        rev = "3fd8fd0e34452fbfc2c1aec34046c53046f3297b";
        hash = "sha256-2rexxdaIDQyZVGgmVWPYCiU5McOsomZK3XhbBu8rl7c=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-12";

      src = prevAttrs.src.override {
        tag = null;
        rev = "8c4e3926bb5403ef245aabb6a25cf838e6fc28d7";
        hash = "sha256-nycoWakYjUoFAvD94LP1LDh1xTfz9a46HMGd3HpZbxo=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-10";

      src = prevAttrs.src.override {
        tag = null;
        rev = "1bc93fd16d5a452bedcc5437923abd0d9fcb8c52";
        hash = "sha256-UTUKGxN5VwZPjSaOCpK9iB+JvWt0lFz9N5wCT0hRCqw=";

        leaveDotGit = false;
        postFetch = ''
          echo 1bc93fd16d5a452bedcc5437923abd0d9fcb8c52 > $out/COMMIT
        '';
      };

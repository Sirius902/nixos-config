{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-27";
      src = prevAttrs.src.override {
        tag = null;
        rev = "b41b10a031f5e5070f52e20b8228ff4f4d389ebf";
        hash = "sha256-x4WJ6XDchJ8J35+bgwWPlUbh6dDJcXCV3Ik+C18op4o=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-27";

      src = prevAttrs.src.override {
        tag = null;
        rev = "1d885f2b5f692517fadb263daba537decdd1139b";
        hash = "sha256-eXPr6mWrrkAZEaqsgssYMbtLIKPhuyZfU3kzXjpn4Ds=";

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-29";
      src = prevAttrs.src.override {
        tag = null;
        rev = "aa7cf5ea153ececef87d0dc0982522ea690b281e";
        hash = "sha256-zjnBzxMw9apE11TFmsBBMfs6/w+9Q2PpS+eHo9DaKb8=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "4b39026527452b64f2da484316b5318f805efdc3";
          hash = "sha256-XZgTj/fbuegzTxuKyWlxChCXyK/Rm2IXXX0A3LFpFT0=";
        };

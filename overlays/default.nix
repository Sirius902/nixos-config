{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-10";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2f4034590f261cc2aafbc10139744c68a146b5a4";
        hash = "sha256-4InBT4NVvuMIzEZdmCXJ4XSshJ/ZFnl7nQT5bgC8+kk=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.17.0-unstable-2026-08-08";

      src = prevAttrs.src.override {
        tag = null;
        rev = "c5ae3c681276bd884b9b714c2099d55796c36154";
        hash = "sha256-z3iQQJ/mahPbAo7nVW2tgvDiJBRi8CT82GpLbJIgjek=";

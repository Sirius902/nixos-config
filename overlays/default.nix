{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-07";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2573cc5fd08a2d5e4b38768ae1c69779397d70b4";
        hash = "sha256-a2O644JJTm1A+XGNNU4p4SwI/CWYeOxV0B46+8KOA0Y=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-03-07";

      src = prevAttrs.src.override {
        tag = null;
        rev = "014b11e9da8765b281b331a1edff15d12c365d7f";
        hash = "sha256-5G+iM3A0ek2abfOB4f7Rr7BEBywQ9R0HUopjHrRh3tg=";
      };

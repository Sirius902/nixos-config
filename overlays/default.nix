{inputs}: [
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-13";

      src = prevAttrs.src.override {
        tag = null;
        rev = "ec334904604ba41f5d4753f4a2498ec82540e5d6";
        hash = "sha256-K1EJB+tIWgJZX8y+LkW8RPg0f2wW7Y0tL/U6JMkuVNU=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-13";

      src = prevAttrs.src.override {
        tag = null;
        rev = "cdaf67c6ce4b5a23c3dd759a439d2bf434396791";
        hash = "sha256-WGT9/kzMbIj12ynfUOphX7DuBN730O+AqEJQqLD471U=";

        leaveDotGit = false;
        postFetch = ''
          echo cdaf67c6ce4b5a23c3dd759a439d2bf434396791 > $out/COMMIT
        '';
      };

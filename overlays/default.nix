{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-09-16";
      src = prevAttrs.src.override {
        tag = null;
        rev = "e13ee157918ed0402bd2befa1920202d63b3e8dc";
        hash = "sha256-OVpF6uTTkyyW6gkkEI2zjJjDRNeED+y8QH92MwUC5IA=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-14";

      src = prevAttrs.src.override {
        tag = null;
        rev = "a5d307ee7ab3d1eee7bf82016cb2b5da5401b491";
        hash = "sha256-3q783JAQAWIV+LzN1+GoMBziZ1q+JB3nZankm0f1ii4=";

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-02-18";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2064bd87e37da1d0946f7c5b62f2d38003abff8e";
        hash = "sha256-VpC7NjHlsXd8L/F0bnq5T8nY9TacqVi7kh/L2oZZGiY=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-02-17";

      src = prevAttrs.src.override {
        tag = null;
        rev = "a99c8147392c806b2b7ffdf876720ba170f17c23";
        hash = "sha256-QShfJvctzsBPbXfFi6SH2v1Lujviz8ETZYMYzqAb1M0=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "dc18ac6e58c36f82570c9483bcff44b2e08098f0";
          hash = "sha256-Oa7z5y3aIEpdW9KnXcJY3X67vj7RZG26b/7fvkbnWyc=";
        };

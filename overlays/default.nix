{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-02-03";
      src = prevAttrs.src.override {
        tag = null;
        rev = "43b2ce65773d2edc00a4499b40607cbdc7e70c81";
        hash = "sha256-EB2R3I8v3okZZzm5VYejFraSIhh5MtwBCgnma0r8OaQ=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.13.0-unstable-2026-02-03";

      src = prevAttrs.src.override {
        tag = null;
        rev = "b43573112cf03a1d805e5b9b41d2c74624368ab1";
        hash = "sha256-Hv6HIcurIwhwx/oXcax75fCr05QDke3UHJvzSsc7OM0=";
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-17";
      src = prevAttrs.src.override {
        tag = null;
        rev = "6523afa69a74bb60b0ffd994dd962a101c4d3ae3";
        hash = "sha256-6DHgttzGzaVF4+ZTMdlxJQZIcgMx/wf2v+8hHY/rzlo=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-17";

      src = prevAttrs.src.override {
        tag = null;
        rev = "6e843d0c4ba977d584d04698d20cf2570131af00";
        hash = "sha256-O5YFLsyiXGC9yOMgaVtG2b3BKnxCO0actQUeCiY/kjY=";
      };

{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "f5e8a2bfa987f4cb7a2a8a58c2abc0ee788aed82";
        hash = "sha256-OvHobQdVzilQvvUXDBFgfHX+fVl9fkiCpFXCOkXaT5g=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-30";

      src = prevAttrs.src.override {
        tag = null;
        rev = "39ef77c71626aee51681f3b662c648e82ca03013";
        hash = "sha256-deHRRWxrMXnDGL5OD53KefGh2Fq4BIZhJf1jvWLRJTA=";

        leaveDotGit = false;
        postFetch = ''
          echo 39ef77c71626aee51681f3b662c648e82ca03013 > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-14";
      src = prevAttrs.src.override {
        tag = null;
        rev = "0b9c53e254340db8c7afb4ed0b994d1278b0ead7";
        hash = "sha256-ZNB3nP3EgX0GY0ez9whUjwIwlwAQVLdFFShgz8uyqvg=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "b12ca606c846258066af15b84f6e918451fbc10f";
        hash = "sha256-5WmmXGSKXQ/zpbC9KccL1BEazPrM4JcOo05oY8lysGQ=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "3b97226adb80093400730fdd05f05812f93a7593";
          hash = "sha256-MkzQRcdlkvHnw6c2MXwJwJlq2xlXpcp+j2yGRiMyZ9U=";
          fetchSubmodules = false;

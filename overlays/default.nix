{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-09-17";
      src = prevAttrs.src.override {
        tag = null;
        rev = "e76fbf4489e682289ec388433f1aa06887335634";
        hash = "sha256-1Faw3bGrzFsLP5Vt+pu4YJUs6A5S2rpxNv09PKzLHDE=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-17";

      src = prevAttrs.src.override {
        tag = null;
        rev = "ba7470206cd937456f0162d7fbffdbcf3e0e261d";
        hash = "sha256-8ZtRWBwyjiFa7BLZgp5Ady/UdBwdF8FE3ZrPtwJHclc=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-09-16";

      src = prevAttrs.src.override {
        tag = null;
        rev = "ee018d00e60b9eb727489908a8daec5c537f44a8";
        hash = "sha256-TGkPKeDJrQl9JtBU4NXZfIkI8sIJeE5h2qoUZUWFgAU=";

        leaveDotGit = false;
        postFetch = ''
          echo ee018d00e60b9eb727489908a8daec5c537f44a8 > $out/COMMIT
        '';
      };

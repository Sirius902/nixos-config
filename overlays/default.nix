{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-18";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2d6ca912fe7745a2f5a26cb9a0f1f5c13590afda";
        hash = "sha256-G/mB9HDEXh/X8VFTPTdhtkSx1oPyHQ2kxSnes9D3o9g=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "df91fb347c2bef78fd89008c204e52320a9ecc1c";
          hash = "sha256-j2vwTeOTGfnorcGZVXgCyPD1l0ihgBGn825Xkrm4uMw=";
          fetchSubmodules = false;

{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-05";
      src = prevAttrs.src.override {
        tag = null;
        rev = "3d587726a23f514be0e7c3ac43e2db0cf2fe931a";
        hash = "sha256-gmJmMwVh2060ANExDvJonchXCQc9GdnbNUvhqctjoj4=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.17.0-unstable-2026-08-06";

      src = prevAttrs.src.override {
        tag = null;
        rev = "8bdec718b6512ac8d17a44efa0039c06c6810f6e";
        hash = "sha256-e9evKN1wm8ZiuuVvGUCWgL7DsT5PMJ5Sii3Yw8PMAng=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "f15f97046b171b26fdaf37f85e197d11abd61b77";
        hash = "sha256-BLNuQ3Ri1Z1xxLRI3y84bguP4MsBkaCbK/nwnNFkJx8=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-08-03";

      src = prevAttrs.src.override {
        tag = null;
        rev = "66d8a892203d76a1f7349ed07526089b828e3835";
        hash = "sha256-vgyUlHBEoDgvtuPvX8T60Kf0yuLPy4Zqvb60WHJihXI=";

        leaveDotGit = false;
        postFetch = ''
          echo 66d8a892203d76a1f7349ed07526089b828e3835 > $out/COMMIT
        '';
      };

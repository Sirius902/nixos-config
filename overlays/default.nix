{inputs}: [
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-05";

      src = prevAttrs.src.override {
        tag = null;
        rev = "256546c430d1ba22d166a24dca18c084abbbd54f";
        hash = "sha256-5mj1iRzFcJDJSTiQ/KEF2uaO/lxHsO9QspGm1MFX760=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-09-05";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f0862e12e18c75f508aa5423f8726bf5b39d8e8d";
        hash = "sha256-Y08YZ/AiXs6xOCJxxkF9gL3pUrZj0WAQZVYcE2S+yek=";

        leaveDotGit = false;
        postFetch = ''
          echo f0862e12e18c75f508aa5423f8726bf5b39d8e8d > $out/COMMIT
        '';
      };

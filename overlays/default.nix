{inputs}: [
  ...
  (import ./claude-code/default.nix)
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-13";
      src = prevAttrs.src.override {
        tag = null;
        rev = "320e8d634ae0a0dc0917e9483d12e5156c655160";
        hash = "sha256-9NNzeHTE3MiSZeDvbd8Fusn8f/B+U1TNu4iCj2QIch0=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-12";

      src = prevAttrs.src.override {
        tag = null;
        rev = "0c78ea9bbac9a3e48e6620e91b3f1fbac8dea71b";
        hash = "sha256-kB1wcur5/XEIPoRChRJiHScRDUVjrXdPN0h4jm8T0A0=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "fa2f8a066daa7ba7ddc435c5396a88f060290c59";
          hash = "sha256-+OUiJAZImkp9k47mCs+EAePDO3CiYJAOcbWQyYyr3Uc=";
          fetchSubmodules = false;

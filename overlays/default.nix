{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-27";
      src = prevAttrs.src.override {
        tag = null;
        rev = "03d03b2bb4440c4065ef8be793ed0bdcf97a3a4f";
        hash = "sha256-YxRvjHYFOgeAbFWt5cqDC5rSOEVW0b1g3mpVtMem3j0=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-27";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4f8af23db516d8b6e9cd00e7b261a65b026514a8";
        hash = "sha256-iGww/BgPDa0DEDSomXg0W7GpQJDR2O3AaoCVmOab4Tw=";

        leaveDotGit = false;
        postFetch = ''
          echo 4f8af23db516d8b6e9cd00e7b261a65b026514a8 > $out/COMMIT
        '';
      };

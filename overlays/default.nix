{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-16";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2eba7da8e60e24ce698ebb7818f7b78cfac0e18b";
        hash = "sha256-wneoY0XhKnbpxWN6V35eHtkacSnt0mHBYQn0iMCVEvA=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-03-14";

      src = prevAttrs.src.override {
        tag = null;
        rev = "30ff9cf05045124d47843512568fdd7cfbbbff3d";
        hash = "sha256-6sACPs6gSK+PK7Hn8ZhxBgOvRobLqPpQ+xEkGClDPkg=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "d961f92bda8afe05541690738271ebd53ddd0188";
          hash = "sha256-sJsO/SoU3+8t7/0FfCrSyIQqKMc/YmB8ZSinYPw6Nbk=";
        };

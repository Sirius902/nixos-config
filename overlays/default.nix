{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-12";
      src = prevAttrs.src.override {
        tag = null;
        rev = "26e37d8c8ca758fc81dda57521ed8f9a68d042fd";
        hash = "sha256-96JH+1J/AIm+Nbu5YP5j/pDsPS+yJ49uSOgA0BvIhAw=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.17.0-unstable-2026-08-11";

      src = prevAttrs.src.override {
        tag = null;
        rev = "05302af14db01da39ca850775e91750c1768c6d7";
        hash = "sha256-M2xG1XOnHVbVC4wQ52mGDfFauCvOTejaAZQif1RKQLI=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        ...
        hash = "sha256-2hneoMe14vYkYHGMr2120IWIhHWAe6ZqVy+/IzpGiQc=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-11";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4ff214cdd26f135251d2266d676ed72dc1c2f8c9";
        hash = "sha256-pRwTF4RpjsHiq0/QS6Lwuax9MLo4TMohsr0QQdBkdeI=";

        leaveDotGit = false;
        postFetch = ''
          echo 4ff214cdd26f135251d2266d676ed72dc1c2f8c9 > $out/COMMIT
        '';
      };

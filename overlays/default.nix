{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-15";
      src = prevAttrs.src.override {
        tag = null;
        rev = "7d41bbdd2b645655ff8f8bab5237e0df934bbda3";
        hash = "sha256-tp399okokl4+uor9PT/lloyjLdLcy4pihoYr1dq7EeI=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "fbb4b4f77db854d1fd6efd9c8ac79657a8e4f18e";
          hash = "sha256-B4ES1VNyGsucsBVQWspfpUb2GNPiBSvLwaON0625Wio=";
          fetchSubmodules = false;

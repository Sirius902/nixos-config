{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-02-04";
      src = prevAttrs.src.override {
        tag = null;
        rev = "ebf9374ccdfe9bc1d8a9535d6b3c5335e03e9ac6";
        hash = "sha256-fMMMItjiokMBCH4W8BvzKJ/brdwnHYLgiMMaIM+t+6Q=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.13.0-unstable-2026-02-05";

      src = prevAttrs.src.override {
        tag = null;
        rev = "b88ec484bafcee9bf8b4a6cd7bad8520ea6f981e";
        hash = "sha256-M3ZeB6L0qpZ4qz6mqJG5LHroZyUM2jAmPEUF4GVXNzk=";
      };

{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-14";
      src = prevAttrs.src.override {
        tag = null;
        rev = "49b0306b1dba43c2f966c96667042b2f5ac22988";
        hash = "sha256-DBckXuld+BmA1k3uEtOwi7pL5BtmPsNWscgfd1e2w1M=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "1f407a41bd809eede1917b6d73ef1c3f5548d451";
        hash = "sha256-40adSfRxRKL0VKyE/Ecd/12tdAtDfFWcjc/TJjmj2zM=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-14";

      src = prevAttrs.src.override {
        tag = null;
        rev = "d3b2943807dd0073f7767947466dd73cccfef319";
        hash = "sha256-5bnuTkO9UQqAZeSahmXOT4s86Wybhtoii60rAI9p1s8=";

        leaveDotGit = false;
        postFetch = ''
          echo d3b2943807dd0073f7767947466dd73cccfef319 > $out/COMMIT
        '';
      };

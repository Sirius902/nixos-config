{inputs}: [
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-25";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4dc3cf83e47aad28f4599662ec3e3c48ae416474";
        hash = "sha256-HiY1qYIpcr3EniE7/nwC/hiSJmxXfJl8yfrbictDOE0=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-25";

      src = prevAttrs.src.override {
        tag = null;
        rev = "707d3c7a732634ad8d522bd27e52b075f54ac4f3";
        hash = "sha256-9KCy9faEnKzVdiGgSgH06vVKw0xlVVPno4Gtyfw0FbY=";

        leaveDotGit = false;
        postFetch = ''
          echo 707d3c7a732634ad8d522bd27e52b075f54ac4f3 > $out/COMMIT
        '';
      };

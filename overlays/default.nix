{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-08";
      src = prevAttrs.src.override {
        tag = null;
        rev = "bb5dc93becea08888518a65920c11afc6c3d6e50";
        hash = "sha256-BkSRGVLVtcJokZak1vSILLyH+Rz0Ulh++wWapuKVA4E=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-07";

      src = prevAttrs.src.override {
        tag = null;
        rev = "16d5f9c54c5302b9fb8075321ec95cd2ed89423b";
        hash = "sha256-TRbdEqaRB8RR8yYOCBzKK/OSkgqp6U0xXYSFiY1XaQQ=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-09";

      src = prevAttrs.src.override {
        tag = null;
        rev = "aaeb6e5dc1e0e7377b1f9cc48203051f09282217";
        hash = "sha256-Lt26AZEbJxyn0rK3mADSbYgX+Hm7d2td72uX1fXcUe0=";

        leaveDotGit = false;
        postFetch = ''
          echo aaeb6e5dc1e0e7377b1f9cc48203051f09282217 > $out/COMMIT
        '';
      };

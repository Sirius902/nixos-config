{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "c82221f292880272d11302ecf1206f81a970a5ab";
        hash = "sha256-DVHT01+O2Eub6DobqNbF9JmezY/1jtO6GXhUvSG/ORc=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-23";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f22bce85ed877499cddde5ce36d637d77ec6d398";
        hash = "sha256-ElEwtXnyXK3xnAljRYrCthg2LXq4hWewy/UujNCn8BY=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "0d93fc035539f25790deca638d06ee3b3b45ee64";
        hash = "sha256-ktpjpAB+6L2Vz0cmxD9YWuw+G9z3kHz1qgh3YB4rm14=";

        leaveDotGit = false;
        postFetch = ''
          echo 0d93fc035539f25790deca638d06ee3b3b45ee64 > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "a7fe472583f687dcb17699059e701cbac48fe08f";
        hash = "sha256-wPqbhgHJun1fw2Bs4bU31yX9OG2euUuMY5oSPP6lYHA=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-29";

      src = prevAttrs.src.override {
        tag = null;
        rev = "24e68bafdea0bb89a909a691903e1e204210ff93";
        hash = "sha256-CQaX+Ir6w9z5R6RtWpowSNaPscuA4HaKSHwiHGPfkmM=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-29";

      src = prevAttrs.src.override {
        tag = null;
        rev = "8b8d0847aef953feb7c8a0326ea20b7e71b2db32";
        hash = "sha256-zBaCbJnxEQme7DbFmGQM41rAcwXJnqkCUU364xbflBA=";

        leaveDotGit = false;
        postFetch = ''
          echo 8b8d0847aef953feb7c8a0326ea20b7e71b2db32 > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-21";
      src = prevAttrs.src.override {
        tag = null;
        rev = "b97f4bd8da001396e62b5990b6563c929ec4aaa5";
        hash = "sha256-T7+zPXnCua1AXnsvmBo4+agYlgEkrLVi4jfkfM+Cc3k=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-08-21";

      src = prevAttrs.src.override {
        tag = null;
        rev = "443676d825d3b5c3f7d7fe3c84899b5896892c2d";
        hash = "sha256-8jOol96TVG53G30yvkvmiv8D1A+YIEY4Ad67sGfcc6U=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        ...
        hash = "sha256-nwqRfwmWbblL1ShPmfvOggmo1+Z85W0V7Nul7VGo6ec=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "38e70fda6597dab6b7e5e4d3949b199c0b4f2244";
        hash = "sha256-QHzLfgiuDZyU/3z5qH8b5ZNbdly1nRM1LcQsAgMCezI=";

        leaveDotGit = false;
        postFetch = ''
          echo 38e70fda6597dab6b7e5e4d3949b199c0b4f2244 > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "0c0614a4df4bcc4e68e17ac9ba555f10f1d9645a";
        hash = "sha256-b+Dv3HkLFW9CGmQZ33rUoIQS7i1wrktCBTKMIwUOtII=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-08-29";

      src = prevAttrs.src.override {
        tag = null;
        rev = "297551e00c1cbecb1ac14b79e0e91573c1bb8a55";
        hash = "sha256-odLlK8iMLwJDsjOwYNvQknd83jtZE0BC8yoo9OBCSsQ=";

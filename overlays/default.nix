{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-06-06";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2d1be0918044c2bd906403dfb310ae8054d13d44";
        hash = "sha256-nrXTtlBBDspu2+Tozh5qrsd2FwKMHqkvEbuL05FJfFU=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-06";

      src = prevAttrs.src.override {
        tag = null;
        rev = "057454fe7fa4e5b47fb14156f1ff28fa95115ad5";
        hash = "sha256-ahD1YmsegJ1NOyD1Ntf6tsp1Hdkal97SXEeZQggyxNI=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "b4a3a80d4624cfff6964896cc4de1fc1db6fd512";
        hash = "sha256-EBgwAB3DW9w7HQOc50vNw7wmhpFmdO0fzTWg9VjdprU=";

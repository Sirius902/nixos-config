{inputs}: [
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-29";

      src = prevAttrs.src.override {
        tag = null;
        rev = "2334981be80f8513acb352ce8c442077609e3beb";
        hash = "sha256-S9RIBzCqbkLoQlZrJx14vJCfrktYMUZ267F/0AJvgcI=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "fbfafbdec823ca62b95bbdd27645f8837899a094";
          hash = "sha256-E5ty09mxA1CGLlFM4yOhQET1gAtZ71K/6+Wp3ekCitY=";
        };

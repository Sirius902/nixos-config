{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-04";
      src = prevAttrs.src.override {
        tag = null;
        rev = "ec989781a345839423b34656beda5e7e62a98c3e";
        hash = "sha256-714g+pj2aqzyc89B/KG64nLHLqq8yaqObC5d/uJTjZE=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "73904cf206d515b20cf6eb83dc3f1eb75ed87e2a";
          hash = "sha256-j47swvRVTmEUV7eq8vwFsuO02byHyrUC0bVVL07aYnw=";
        };

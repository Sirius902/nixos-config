{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-24";
      src = prevAttrs.src.override {
        tag = null;
        rev = "071c9f10f159f18b0d568259204788be5c277ec1";
        hash = "sha256-Rh/FotY5MZbXYgP/GvIY/5UlusbjZhLuQC/ERtU0IJE=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        ...
        hash = "sha256-LTsUI0dcE56o6cE20yZ+t4CxVu0WzV1y7ntnqxCdRWs=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "950c289945302c2e88671be248d6f9068bee343c";
        hash = "sha256-hyhwHtTdukTZhqVxQst/lBHsJ/S617j6HeaeOQZT68s=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-25";

      src = prevAttrs.src.override {
        tag = null;
        rev = "26d5cd38bd068f878b6e64ee8b705787b3a16164";
        hash = "sha256-3WdkY0OGelH2kwaV9hUSc5/0rOpL/iDrD1i/PnR+D3M=";

        leaveDotGit = false;
        postFetch = ''
          echo 26d5cd38bd068f878b6e64ee8b705787b3a16164 > $out/COMMIT
        '';
      };

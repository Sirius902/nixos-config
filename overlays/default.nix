{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-22";
      src = prevAttrs.src.override {
        tag = null;
        rev = "5a90dc005969218aa05b4cfdf7cd24d3aa259986";
        hash = "sha256-cViJxK7pusMYP84pJMObQNTVTTV5gaRO0aEb8cLJVQU=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-22";

      src = prevAttrs.src.override {
        tag = null;
        rev = "edd50ab2d0a68391b6057c82aee605735350e375";
        hash = "sha256-e9stS34sMrNSianNyXKsf0tYdLMTMoS8GAMlyxWJrFo=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "92bdc40eef82a7a3ee241c35ba961d11a902dd8e";

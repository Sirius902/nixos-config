{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-05";
      src = prevAttrs.src.override {
        tag = null;
        rev = "ce12c29441a3c1755610d427bb23edbbaa169641";
        hash = "sha256-JXu78JgcwVeTnMO8AgkUbVQQdFLBCTYLvSVaxPwD+lM=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-04-04";

      src = prevAttrs.src.override {
        tag = null;
        rev = "b365d5fe7819d4d0231fb74561e725e136090a28";
        hash = "sha256-INhpykrFcEY1/AWTxxTdqZyxEd0rojbPCyLfR0x8lQg=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "5513922a859a86622569a149bfd8b315c2676cf4";
          hash = "sha256-KlUgS9RrJkpKtz0L7Uveey1YHEdpufd+3iWJooR7X9c=";
        };

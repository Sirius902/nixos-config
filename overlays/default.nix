{inputs}: [
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-18";

      src = prevAttrs.src.override {
        tag = null;
        rev = "caec23154c27f7f7a802a27798bbe1b3e4c531d0";
        hash = "sha256-cOLxGWKG9QHorFgJwGUIqbfSbk5M+0gKeh18LTH0PVQ=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "2d696e8be97a75dd929f51677a68dfc9a337d041";
          hash = "sha256-x6/d7x+rU44cbY7m9a/kIPyhD15N5TW6OxWC6vWelss=";
          fetchSubmodules = false;

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-08";
      src = prevAttrs.src.override {
        tag = null;
        rev = "431222149882e63a30fdfa7fcc6b25db4e1dfc43";
        hash = "sha256-idKLftpBCk4j4+QH4SRrBhsYAD4okDtc0PUs3PXBKC4=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-08";

      src = prevAttrs.src.override {
        tag = null;
        rev = "7132795b7a753c5a150dfd410f4fbe3f0568a960";
        hash = "sha256-knJkmVM0rgLwGLATGVWLN5D6r/RB6NDqE7jh7PPFizk=";

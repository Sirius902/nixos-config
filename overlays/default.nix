{inputs}: [
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-05";

      src = prevAttrs.src.override {
        tag = null;
        rev = "db43acc4f91e347f713ad405cc0d02f85c9b8b4e";
        hash = "sha256-YaKZa8HuMbe5+RK0/f0lNx3VyH6oosAHavEACAQOmNk=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "d4b9737196aecad0eebbfe903b1e8b8796bef9bd";
        hash = "sha256-JqV39Zq5zOpSkble16bk6rs3iDEfBsQ0GpDf9yqf3ls=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-05";

      src = prevAttrs.src.override {
        tag = null;
        rev = "774200dcf4ccea148ef357cc8cf86d8eab4446da";
        hash = "sha256-8IqqJlNtt2xWsu3Zr1Qbb9cBJVS+Cc3zD7WNLqdQtDk=";

        leaveDotGit = false;
        postFetch = ''
          echo 774200dcf4ccea148ef357cc8cf86d8eab4446da > $out/COMMIT
        '';
      };

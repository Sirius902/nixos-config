{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-06-24";
      src = prevAttrs.src.override {
        tag = null;
        rev = "09d602fd5a15d1ca92c9ab9927322d0b185eb45b";
        hash = "sha256-P5mO/dIY4wRkek0W0/fAbNuR4lkDkOJ5OlxrUi0eVt4=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-24";

      src = prevAttrs.src.override {
        tag = null;
        rev = "aff387e8a9fdc01e93d4ee79cf3a910867cd2818";
        hash = "sha256-SKHEDM9c66GJ4j+CR1+rdDFYmjFu4+y+x0WQEzFkMNY=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "cead95c781211cccc83fa54e7ec5f180938fcd14";
        hash = "sha256-l66ZYW6/azgwU353fmwuNfLux9sqEWuoSwIDwGkeQfY=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-24";

      src = prevAttrs.src.override {
        tag = null;
        rev = "2f1c14cdc70429eddd85218b3ef32bf00387a8e6";
        hash = "sha256-1HgeeR7uJFhTgCYfAJABEveDaUZ3DAuXPevrKwx7Piw=";

        leaveDotGit = false;
        postFetch = ''
          echo 2f1c14cdc70429eddd85218b3ef32bf00387a8e6 > $out/COMMIT
        '';
      };
  ...
  # FUTURE(Sirius902) QEMU 11.0's HVF SME2 self-check
  # `g_assert(HV_SYS_REG_SMCR_EL1 == KVMID_TO_HVF(...))` in hvf_arch_init_vcpu aborts
  # the linux-builder on Apple Silicon. It's a harmless consistency assert, so
  # neutralizing it restores HVF. No upstream fix yet; remove once one lands.
  # https://github.com/NixOS/nixpkgs/issues/528299
  # https://gitlab.com/qemu-project/qemu/-/issues/3533 (sibling assert)
  (final: prev:

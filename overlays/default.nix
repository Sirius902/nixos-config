{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-18";
      src = prevAttrs.src.override {
        tag = null;
        rev = "7973b8ac6d5ec8b488e2bcf87769d082f7298888";
        hash = "sha256-6Sl3jIB6FKoFf+ulZUfrKZxhSdcPI438P4pxYsve/dM=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "11a5e47a7f0612571629d247b96bcfb23868ca38";
        hash = "sha256-DBquhUDJcukPGACl/o2SK5ID9GbHOj3YnYUb0qWo6EY=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-18";

      src = prevAttrs.src.override {
        tag = null;
        rev = "a795eaf01d832b22c7c6baa30ba11fdf643a9e29";
        hash = "sha256-SJsl7dtqlVT5MSsKH6xpS6j4kfcB8oovmbg5eF3AY3I=";

        leaveDotGit = false;
        postFetch = ''
          echo a795eaf01d832b22c7c6baa30ba11fdf643a9e29 > $out/COMMIT
        '';
      };

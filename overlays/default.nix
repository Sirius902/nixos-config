{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-30";
      src = prevAttrs.src.override {
        tag = null;
        rev = "1c37f64a58583b2f80ad9bd12f928b49176b60fd";
        hash = "sha256-1fqCJtf25LZ8QI21fCO6j6SE2qeQnlyPNrZAxzQLz0o=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-30";

      src = prevAttrs.src.override {
        tag = null;
        rev = "969955b8a086b79dc107eabbb663ed9cf1308e60";
        hash = "sha256-8JQuQ36L7EVgM/xuVXMBJ6jnOfs95DOwO3TeYZmJaYs=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "a771670775fc0da68d7aaff35fa08d8d3809e878";
          hash = "sha256-9kIzWUvZYbAr5jKBfTfDbO/uUDX2izYLbZNi1gCXy7s=";
        };

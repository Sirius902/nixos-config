{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-09";
      src = prevAttrs.src.override {
        tag = null;
        rev = "77cbdd82ab02d64bfe95048fcf8be3afd968bcc5";
        hash = "sha256-r4Da+6+SSvA485K44cvOYTtxbD0cZqSl7ERcGHDw5jI=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-03-08";

      src = prevAttrs.src.override {
        tag = null;
        rev = "cc6af03adf6208974b0afcd7684358dd83fcfc8b";
        hash = "sha256-EX04Fc8VeRDG+t/QHG8/1ia+kjn9NDpX73EnRLzX+ek=";
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-30";
      src = prevAttrs.src.override {
        tag = null;
        rev = "8c82ce8bed7498f17d2a4e85b239e28593b9c3c7";
        hash = "sha256-qYl6qZzWl3QTqTkKDhebk8hRynZBDnTK+xr/WqPRuAc=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-29";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4ce43a6a88b46570c7432c7e48e64c879030bd8b";
        hash = "sha256-UwxVjDJuPTbbeW8rpwYKw6PEzVXnaReRjTkW1kIBkx0=";

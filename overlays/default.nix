{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-02-11";
      src = prevAttrs.src.override {
        tag = null;
        rev = "7cfe96a1d121e12fbdfe42befe9af5bbd561be99";
        hash = "sha256-hvHYkBOEYktwUwSS2X7CLBIs/70iCYWXRiG+BMnO+nk=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-02-12";

      src = prevAttrs.src.override {
        tag = null;
        rev = "cdafdb744326f6aea32786d8df8d56cd1673c640";
        hash = "sha256-e5jOzxoahlTd08RyKOtotNdYZ/S2PcJL2z0UMEwNbG8=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "088820e2c35974f64e995a9be4705646f4b48cd3";
          hash = "sha256-4Ukb491igZg2ETLFcAQ8/4+GbrMBLHgCnVj5q1nJPEA=";
        };

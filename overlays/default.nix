{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-12";
      src = prevAttrs.src.override {
        tag = null;
        rev = "6f07e8453a8cb84ac400bd96f825751c9cf661c8";
        hash = "sha256-eTonE6xG6J5b7IUUD0X+yOaEfevjXXVx8F7oEo8uf1Y=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-03-10";

      src = prevAttrs.src.override {
        tag = null;
        rev = "ac3786f533024f04c77b5d295a14bca05f737751";
        hash = "sha256-mMjra9bG0efpmA9+u90Il9Ska27f42ljc+QN3egprFM=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "40bfed660a4876a43c88551bf9a73c516834b493";
          hash = "sha256-mSMNkbSEz29I+HuUkxbWTf3FvRLvkDQofY8eDrtLXDE=";
        };

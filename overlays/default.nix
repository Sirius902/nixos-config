{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "bf949109ad1d2f3c963a03419a515eccd3fd6341";
        hash = "sha256-UZjUFQjpaptDDiIhy9Lv8RC1uO6asvPf1tAnvfPo6FE=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-04";

      src = prevAttrs.src.override {
        tag = null;
        rev = "22fb56d51c72cdf00b5e21a96e9eb1f5f3eb47db";
        hash = "sha256-k2MmEyuLwCxqrvgMYi95qjE+UTquXB3tLSnaLr49Nus=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-09-04";

      src = prevAttrs.src.override {
        tag = null;
        rev = "e559fd7c3cfe7eabe9650978655c2f64c1570f29";
        hash = "sha256-SHoqv8MVQwUKrOq+euS1B8oVJRGocEaFSHh510hNCwM=";

        leaveDotGit = false;
        postFetch = ''
          echo e559fd7c3cfe7eabe9650978655c2f64c1570f29 > $out/COMMIT
        '';
      };

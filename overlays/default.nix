{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-24";
      src = prevAttrs.src.override {
        tag = null;
        rev = "a03d4f69f8a57e44e20adb6f0e33a38dd5479326";
        hash = "sha256-UA/TgruI+wxi9zp2Qxp1CBqsnkbMON1Z6nQ2r0VWQBY=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-24";

      src = prevAttrs.src.override {
        tag = null;
        rev = "bb9c223d42ed4ba5e6a1fb7cfb2fe97a27eaaefb";
        hash = "sha256-CAEWOOxIwAO0ffST6DAcWgaaLHPKe+Jhs09N911SJps=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "83b03a986257ffc281c86f07cf52c2483568b805";
          hash = "sha256-yvE9nyMwJ8s/9usxqQqfitO4fqlxJnGz4PJ4dc8UcuU=";
        };

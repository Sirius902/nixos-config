{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-02-15";
      src = prevAttrs.src.override {
        tag = null;
        rev = "ed3d2a096c5545d9a99ab47582eaec899dbbf8f3";
        hash = "sha256-jUv4xNuiy9SpQ2BCXpmJy3+aPLzL6y/ijMtrhOBl8/Y=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-02-15";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4a370519a53e579e849e734ef8a71105cd4d16fd";
        hash = "sha256-WrlTHtVUfuO4vEfymUYY29dub3o4Kw5FZHM0waRGHNg=";
      };

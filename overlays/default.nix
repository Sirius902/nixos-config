{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-08";
      src = prevAttrs.src.override {
        tag = null;
        rev = "8d034a36e8119165a581c0f7c6c76c5f156886e3";
        hash = "sha256-ViAOgrFcNVBi+WttgoEUfiCx+nJFe7fGGEgJOXv6UHw=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-08-08";

      src = prevAttrs.src.override {
        tag = null;
        rev = "cd3ea814628d36939340ef67a6edb19e6b094279";
        hash = "sha256-mulmpIOYb82SpDB51yuCO36mfxcBxyiTGkmYR4ZaifU=";

        leaveDotGit = false;
        postFetch = ''
          echo cd3ea814628d36939340ef67a6edb19e6b094279 > $out/COMMIT
        '';
      };

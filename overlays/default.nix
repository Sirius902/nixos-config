{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-11";
      src = prevAttrs.src.override {
        tag = null;
        rev = "fb1c1eeaefe61aabad521e4ca73afe65e428a285";
        hash = "sha256-h4VSvbZ6HMnKUEZckfqbmFgjceXiAkrWcME1e+zl14Q=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-11";

      src = prevAttrs.src.override {
        tag = null;
        rev = "89b886348e743c4036e1206e5ae8d0f650b3676d";
        hash = "sha256-zj68a01Rw+xoN4qeLCHNdu9p1dReza/2MKYByi9NVN8=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "032977ebde4bc8ef947067d54b20a37c007aeda8";
          hash = "sha256-oKFAKA6/oHrHJctJ/35+ZmPkbwDn5OfQ0D0reRVG0ks=";
          fetchSubmodules = false;

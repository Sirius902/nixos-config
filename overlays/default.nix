{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-14";
      src = prevAttrs.src.override {
        tag = null;
        rev = "12b1efc26601b20f85f4d040582e7473388bb553";
        hash = "sha256-n4RullPfKb9RbFFbEY57jD2Y/NfCOZ9wsGD8RLIhPpY=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.17.0-unstable-2026-08-13";

      src = prevAttrs.src.override {
        tag = null;
        rev = "85382937e81bcaaf11c9b635f48f953329c2406a";
        hash = "sha256-QChdTQfvQKzDbRYPxT6y0veZMwtUF2Un0uuQGPDtM2g=";

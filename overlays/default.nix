{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-20";
      src = prevAttrs.src.override {
        tag = null;
        rev = "6a2ad0a0aa17c994ae95f492bfd27a2a2b3c2b0f";
        hash = "sha256-9PBl7gbhJ8cRLYfd9wtPQsLghaGisR2WLFbWRlD2pNg=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "790d5ad23b132d657f701f8cdd4715c6807a80d0";
          hash = "sha256-ZQhGBvTa02/JFOHEpSzrq2dBVmOTyBjzj3/exAf7LMc=";
          fetchSubmodules = false;

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-20";
      src = prevAttrs.src.override {
        tag = null;
        rev = "a088b18e955e01c4a63b32baa1fc6a56c3af475a";
        hash = "sha256-Wn5DITQ7MeDsKUtnqXJY86juRKg0rzwEe0n6WX7OkzU=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-04-19";

      src = prevAttrs.src.override {
        tag = null;
        rev = "90b75eadec64e770fe9aa20457566cad04d35f25";
        hash = "sha256-VmVIW8egtOrCTRIcdcR+AaGU2rtcqNH2F+VxBa5KRBw=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "6671c44982100cd6fefe9612aa941f07d682aac9";
          hash = "sha256-bcqpUcrTnSrvmFqO8DSgd6YD9hFxry2Yz+B29N5tZx0=";
          fetchSubmodules = false;

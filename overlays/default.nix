{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "f32ff351da5962588c1b4a26c3ec8ade5fd4010e";
        hash = "sha256-fermCHGjYwW24LvYaTd/kjxnU/rC5v2FNhvEb5yCqvc=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-09";

      src = prevAttrs.src.override {
        tag = null;
        rev = "d7ccf25e6fe82efed626111b521af0a03e23dc40";
        hash = "sha256-LP4ROTS1nH2t76CnsJiKN82LKCfoZ/NbceiYZc2MlJ0=";

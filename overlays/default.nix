{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "87608865b60de01480320b4a29a1bcbda387bad3";
        hash = "sha256-dg4ubL/04EdJAS55s1IreedLinhRSwBjZKAfRQYgtiU=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-22";

      src = prevAttrs.src.override {
        tag = null;
        rev = "7bb1f9df7b7f43a505f23e27d88e7355ea586409";
        hash = "sha256-Ea/hlvJI5yydJo9dK8Dl1XJwtGwzs2Ekl1DAfGQrQKQ=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-23";

      src = prevAttrs.src.override {
        tag = null;
        rev = "8230647205bf18b782126df821b81e76e90e2722";
        hash = "sha256-QlPMN9ETtmJ4d7M186jz6H/jgUF+70Y/681rgBX7ciw=";

        leaveDotGit = false;
        postFetch = ''
          echo 8230647205bf18b782126df821b81e76e90e2722 > $out/COMMIT
        '';
      };

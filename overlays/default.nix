{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-09";
      src = prevAttrs.src.override {
        tag = null;
        rev = "e9fb3572f95a1ff758cbe545191e68d4d8676a73";
        hash = "sha256-igi6w+0TsE1obWbL9jj5weHQeVThbylyu8CFEw010OQ=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-04-08";

      src = prevAttrs.src.override {
        tag = null;
        rev = "36e11fcce58d04a3c01e850e9659d2f10fac0532";
        hash = "sha256-OiGsk/JtoAFLXjSDj6U/KrUQNMSoq9z1uZnoEYSGztM=";
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-30";
      src = prevAttrs.src.override {
        tag = null;
        rev = "c25e3e33acdcf0e62f8b52a201e5c189fbba5b16";
        hash = "sha256-7FDGx2jrI3WzRZPEA/IEDIi9CgmkyonlrHTVhAZDLt4=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "5bfec866b16aba9337b58f17d5d3103aad72ce54";
        hash = "sha256-ReOR7gEfQu5JH96orJnyUpguRFNhG5+iJekZTgkF9Xw=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "76246a327b8805d355738157ea444e4d9a799ea3";
          hash = "sha256-+w+5TeDp9XnDKEC9PjALSARtJKfCMsacEfibo4ZX53M=";
          fetchSubmodules = false;

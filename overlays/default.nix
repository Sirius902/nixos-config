{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-15";
      src = prevAttrs.src.override {
        tag = null;
        rev = "b533a560e6df6f8aa1c271bfffbd1e39f500bd65";
        hash = "sha256-98UcDI71NI+X3xFDr7AHoNbdM7J9OqFoovv9MuyXrXo=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-15";

      src = prevAttrs.src.override {
        tag = null;
        rev = "7337364f4c55f7426357002f3462c0fab090d462";
        hash = "sha256-GtRl83NzAtNBZi0/AEUbGoi9EPVpbMzRyBubVXZ8ehM=";

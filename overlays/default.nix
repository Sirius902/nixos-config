{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-28";
      src = prevAttrs.src.override {
        tag = null;
        rev = "51ea735cb5fab5f3ab0dda756f19a753aaa07451";
        hash = "sha256-YV9hWPslWzb2I9HYUPJFDShbeiuzJT1v0/rS49rZqiA=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "1018660ad70453b94fdb8ef58872de4e160d68a3";
        hash = "sha256-ZzcjzZk3j6pHLIiTZXqIO/ptPAfNUHZ9aWbXaaWY5SU=";
      };

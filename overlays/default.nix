{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-05";
      src = prevAttrs.src.override {
        tag = null;
        rev = "4f47fee36039f38449830eccf10e72282d680f1a";
        hash = "sha256-GMknuhANwDYz/0AxqXYZIw7GHeXj06Emv01shTl4tjM=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-06";

      src = prevAttrs.src.override {
        tag = null;
        rev = "d85a5013ecf279f7b78c859b82d84fa486f8ee15";
        hash = "sha256-WSxTzHQ2HS8Flhj6gi9dQ+8biKz0E26KtxLiuYrPl2w=";
    ...
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          ...
          hash = "sha256-77kx8YI6FNWLltsOu7lBdfdRuOVOLVBnaoFtt0JL1RQ=";
          fetchSubmodules = false;

{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-06-14";
      src = prevAttrs.src.override {
        tag = null;
        rev = "4fed5e7b88d78c03359009377b740a3c826505a7";
        hash = "sha256-NjlBPYY53srrO0atrNZmsdJefEPh4RHQ5wgFEVZtI7E=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-13";

      src = prevAttrs.src.override {
        tag = null;
        rev = "3590426ab8059cec74220340470138ae0b3aa515";
        hash = "sha256-UXJnoJAWYAjxGysDGddH8amNsUYTC49Swqsjgmp93UE=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "71cf42839ac19b75dfbeabb77db4fe6060fbb618";
        hash = "sha256-HSZGGo/bPV19npDnNgWIOVAZy1mNrWZYITFAFXIT4u4=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-13";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f96a7682d45d1815cf419ed7461faace998389d1";
        hash = "sha256-sV+qa/hfpG/D7KlYo2eGuBq7De3dFgoGu+l4YhZRxpI=";

        leaveDotGit = false;
        postFetch = ''
          echo f96a7682d45d1815cf419ed7461faace998389d1 > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-14";

      src = prevAttrs.src.override {
        tag = null;
        rev = "6a20ebacdec47c914e8848341242f40c97af2875";
        hash = "sha256-GzfgG345riVaqpFVCzCGhdXF6SQ0vFvPfxJwrtJGDb8=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-14";
      ...
      src = prevAttrs.src.override {
        ...
        leaveDotGit = false;
        postFetch = ''
          echo 144d19433aa734c19c34e5978a1b817d2aa12663 > $out/COMMIT
        '';
      };

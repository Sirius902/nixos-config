{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "64da425e8107918edcd22c5ecdf575822efca76c";
        hash = "sha256-plxj0JhBKxIGlqzjTX1QTLH2K1ScnP1H9l0Ic6dOnZA=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-08-19";

      src = prevAttrs.src.override {
        tag = null;
        rev = "0deda5e2a4773d661ed57b586c4ddb67c525c688";
        hash = "sha256-djto1HeLenlsq+9kxMWb0Zb4EuuJS5wzTJhNc8rBFpI=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-19";

      src = prevAttrs.src.override {
        tag = null;
        rev = "2366c4e34374356c0fdb3219bfcd9ae105e83294";
        hash = "sha256-qwA+Kej6mZ303cq1fP1Sk+9SyMA8aGpoSSkZ2cMQNzg=";

        leaveDotGit = false;
        postFetch = ''
          echo 2366c4e34374356c0fdb3219bfcd9ae105e83294 > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-10";
      src = prevAttrs.src.override {
        tag = null;
        rev = "fecb53f86c55fde6e260617f6b1289cabf1687bf";
        hash = "sha256-WcoEh22Q8esr28V5GeZ3fa/brfJMMYakQFdf1ZEEuV8=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "8a745811afc6032708b0ebb2e4f8f656c0e7e153";
          hash = "sha256-M2QQ8A+DtvqEhKEgQ+Ae4fWgDuNAauC8l8WvPLaWQeU=";
        };

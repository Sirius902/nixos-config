{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-30";
      src = prevAttrs.src.override {
        tag = null;
        rev = "f1a858f351043d88fcbdbc9d30cf8b42d817b505";
        hash = "sha256-8JYps1M7gHjQHWUPClP6AG9rFwkA05r3xhhtOmZONHM=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-30";

      src = prevAttrs.src.override {
        tag = null;
        rev = "74c51895c8df8e08a8cd6713de305fe28f36f4f4";
        hash = "sha256-b2PHWP0ti4vI6ErPZr0jcA6VjqnEcXdBuKu3kv2Gk24=";

        leaveDotGit = false;
        postFetch = ''
          echo 74c51895c8df8e08a8cd6713de305fe28f36f4f4 > $out/COMMIT
        '';
      };

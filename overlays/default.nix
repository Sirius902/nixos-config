{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-31";
      src = prevAttrs.src.override {
        tag = null;
        rev = "27f0e879d3cdbdfee1302baedd9f230438b12c92";
        hash = "sha256-dtLYl4t6H1TiyIWLkmeqWgG1zXKKUqN8UqvhNIwLNYM=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.17.0-unstable-2026-07-30";

      src = prevAttrs.src.override {
        tag = null;
        rev = "bf4809fed2865da53ede58723965635e514e2ef5";
        hash = "sha256-EyF2EYrCMHK+wtf+19XbR2HqHxLGdRMEO2lkXih6LzU=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "22747c738306167e31a5032a4e90618eba7abf7c";
        hash = "sha256-Rj/uOc2Nhq2igbC3QtTFENvuXthHNzO0c92C66KM+kM=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-31";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f1b4345d0854f1c4e5e8eb683237a771c6de5456";
        hash = "sha256-MxMrckDuIlZY2PXJM94+SGc2JaKO26RxMUY6nkRUn+A=";

        leaveDotGit = false;
        postFetch = ''
          echo f1b4345d0854f1c4e5e8eb683237a771c6de5456 > $out/COMMIT
        '';
      };

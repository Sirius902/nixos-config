{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "a7fc31f3212c55bf0b70b45875c52dfc94f6641a";
        hash = "sha256-oAS1N1kXDt1GdEe0xflqJK2N+9yT64osORe+Nt2UoeE=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "463fe06dce9ba6e075c76e190f6d2379501a3eaf";
        hash = "sha256-8lH6jdbt1fsi49n/edtzi5U/gKNwXYNMMjzgNjfGc7A=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-27";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f6d14906d8babb1e3219c74e90a92ae717491e58";
        hash = "sha256-nQFrahv3hMgOpNXhXVkon3ubFbi+ywehYmtrbRu5ri0=";

        leaveDotGit = false;
        postFetch = ''
          echo f6d14906d8babb1e3219c74e90a92ae717491e58 > $out/COMMIT
        '';
      };

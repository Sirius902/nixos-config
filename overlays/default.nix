{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-16";
      src = prevAttrs.src.override {
        tag = null;
        rev = "3f493fb20965009c63099e5b2b4247b211668334";
        hash = "sha256-h5n+W8Z2AUl/k1kgqQJvWOxcDcKtJ8Qrnjh9noFor+g=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.17.0-unstable-2026-08-15";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4c4eb586f5bf11dbfd05fe443cd6164e340e467b";
        hash = "sha256-DpL93mjM4sBxU1YNGZwyasEalZVnevczq/nqMQUM+Gc=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-14";

      src = prevAttrs.src.override {
        tag = null;
        rev = "54070da5851e12f2d1a4389daa528e4fb81327ce";
        hash = "sha256-i8TZ0PA6/yy6WuXu4YR8hbABozHwN8V+epo7oAdkbQI=";

        leaveDotGit = false;
        postFetch = ''
          echo 54070da5851e12f2d1a4389daa528e4fb81327ce > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-26";
      src = prevAttrs.src.override {
        tag = null;
        rev = "24fbafdb1dab445926e15db4667f33c04ea9bc45";
        hash = "sha256-Td7pnSV4u3N3E/36vNC9NV/KZLDinTXvYjRn2WO17ds=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-26";

      src = prevAttrs.src.override {
        tag = null;
        rev = "dc5a33d6f179db120c4bf209aae3ae722b724894";
        hash = "sha256-YcLxu4Xc/jwGJkoesDmii8863Eafsse64XEwAY9fDh8=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-26";

      src = prevAttrs.src.override {
        tag = null;
        rev = "d742aa8b4c4d052f7dceaa39022b1fe3996f1781";
        hash = "sha256-jilUOY2fmPPpbLwMTxwbOnMHpyAk/4nbZjR1Ucc3RWQ=";

        leaveDotGit = false;
        postFetch = ''
          echo d742aa8b4c4d052f7dceaa39022b1fe3996f1781 > $out/COMMIT
        '';
      };

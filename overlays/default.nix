{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-02";
      src = prevAttrs.src.override {
        tag = null;
        rev = "d509eb86645401f34da2c3593c96fbf5f0e1fa77";
        hash = "sha256-eESTBzDiOvNl2YNN336Bl7JAI4dmxTS77wWFu/6uF6w=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        ...
        hash = "sha256-U3pUVwcVvyIKX98S06X3sU1BlKqVcux3S5awaEx4vHk=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-08-02";

      src = prevAttrs.src.override {
        tag = null;
        rev = "35925ceb15bfbf5a2369bf382b68d00132462ec1";
        hash = "sha256-IFR6UzKf9q7Q0m+p40AorFZQkIw4ZJZMveIme1t0/M4=";

        leaveDotGit = false;
        postFetch = ''
          echo 35925ceb15bfbf5a2369bf382b68d00132462ec1 > $out/COMMIT
        '';
      };

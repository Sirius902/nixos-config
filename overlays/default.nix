{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-27";
      src = prevAttrs.src.override {
        tag = null;
        rev = "3b21833b8e923a8caf48f2b240453bfc56ebc034";
        hash = "sha256-Ix56ZyRq0c2zfyNoG+gSQTrwhgpgX8KfUwAU8KrmdV0=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "d47b0524ce4fe692bcc2bd770a8fac0c347120b0";
        hash = "sha256-u0DY9V4YBPOBzl+YoLmNTnU97K/uwkBcVBIC3HaHpF8=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "5c0e5bff316a63118839dc1637b1a3dea0a05d0d";
          hash = "sha256-E7BjGsN0Y6ZEthfiRKEy1NMmG5p8YEJCTeZ71cEqBQQ=";
          fetchSubmodules = false;

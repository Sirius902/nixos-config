{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-09-09";
      src = prevAttrs.src.override {
        tag = null;
        rev = "ceb1ab07186de305af85616c342c14796ba2e334";
        hash = "sha256-lphi9dy23gFPyz6eZj+417HRAKjsuba4gQaPcMNbs0c=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-09-09";

      src = prevAttrs.src.override {
        tag = null;
        rev = "3429fe27b5400ca3f47cbcd12ce3c56716fe69a7";
        hash = "sha256-kPi3tcznhXE/rZSKR/BhWb2lHuLxDJloEzqNK+SE2lM=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        ...
        hash = "sha256-11g68b+ZjySUVh4RLrnSRTAhy/f4+71m0TORrWpazm4=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-09-06";

      src = prevAttrs.src.override {
        tag = null;
        rev = "a2efdf1197be8132674b90fe9cf4761df39752ed";
        hash = "sha256-Jd9IY/8KUxWfpDp16IfA51OSeq+lFVgSxntbCAx61Zw=";

        leaveDotGit = false;
        postFetch = ''
          echo a2efdf1197be8132674b90fe9cf4761df39752ed > $out/COMMIT
        '';
      };

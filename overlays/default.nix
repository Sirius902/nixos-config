{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-20";
      src = prevAttrs.src.override {
        tag = null;
        rev = "63851f4242582a877f65514a9d014e6e61282111";
        hash = "sha256-kcE8b5jFoXZx+UBgE38lPH1Yul0GI0QQ5p9OX/EJHkM=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "00626b263f2b654b0ce857742811f4efbf861df6";
        hash = "sha256-oFROje6T2BwLza+PtgEEagZHqjhp0G0UyAwHj5qqe4s=";

        leaveDotGit = false;
        postFetch = ''
          echo 00626b263f2b654b0ce857742811f4efbf861df6 > $out/COMMIT
        '';
      };

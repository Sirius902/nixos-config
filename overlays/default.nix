{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-25";
      src = prevAttrs.src.override {
        tag = null;
        rev = "9b6bc7c1b441a19000925ba79886dddaf6cb0cb7";
        hash = "sha256-conYzxVIdFuKYAAf0oXizIzxaId8+ETgclUoSMuZYQk=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "95c5073b31144bd647b8dc0606b3f8b462c7d5f6";
          hash = "sha256-uXBF9m1FF4Y1gnGzW92CulVuZsvW4mwky58yKpIjQ2A=";
        };

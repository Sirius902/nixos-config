{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "026077a7f80e178d8e891ec32d54f2bb51f527e1";
        hash = "sha256-2fathF8OMR2kAplaFF31gZ9iLhRzRINfFQ0+QU9uIKQ=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "91dfa4a95848f3f1bc0f595b6ad4ea296caae71b";
        hash = "sha256-36VRuHe6OHlzG2f0ZXH90mYZX7UEk6K+2dIINGKLxxQ=";

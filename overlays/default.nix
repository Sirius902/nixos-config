{inputs}: [
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-24";

      src = prevAttrs.src.override {
        tag = null;
        rev = "26f4270174a0a0de9eb5c26fdd99d84ddf9fa2ab";
        hash = "sha256-GxZenHgvhX4ahPCIQjG3RpCi4GnOPZ+vl4NhaH/6AvA=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-24";

      src = prevAttrs.src.override {
        tag = null;
        rev = "d6e803e63d7a809fcafb4e39c79bdf4aabb49c79";
        hash = "sha256-XevCfJ/pWjjmC9SZRAMA+zZJWnt1JBpyoy2dYp0tSP0=";

        leaveDotGit = false;
        postFetch = ''
          echo d6e803e63d7a809fcafb4e39c79bdf4aabb49c79 > $out/COMMIT
        '';
      };

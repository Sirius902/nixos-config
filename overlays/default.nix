{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-06-18";
      src = prevAttrs.src.override {
        tag = null;
        rev = "c0598f61e7e9d96be287c68985b0b438a200f89b";
        hash = "sha256-WIV988JHOihIbamz44EbZUeLv2Z/QeoGQbS06WEaQFE=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-19";

      src = prevAttrs.src.override {
        tag = null;
        rev = "ad95aac35790820cf10a1230e5885cc4ac16d613";
        hash = "sha256-QXO2SMAYL/RutmlNuWiVGvFyhYMdlqwCpBJ/ZBTgL1k=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "4eff207be994dcf867199ba2fb7c7820b61f8f2b";
        hash = "sha256-5pYI4t8g70LUOKg1r2+uuhyM/Ugy0sMVex6mRWqDugg=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-17";

      src = prevAttrs.src.override {
        tag = null;
        rev = "43210d14309b2028cc045fae695c879ef26c9ce5";
        hash = "sha256-2AZOgvGNBbpL8ch+fsaCGaQAT6t4bYQw+rNmnMUeOHc=";

        leaveDotGit = false;
        postFetch = ''
          echo 43210d14309b2028cc045fae695c879ef26c9ce5 > $out/COMMIT
        '';
      };

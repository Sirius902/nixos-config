{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-09";
      src = prevAttrs.src.override {
        tag = null;
        rev = "6d42df0ffc3b6786066e26c559c7de93f1303ec4";
        hash = "sha256-YyY+DBhEZlhoQsjaY/MRP2/KyL+fpiP59FVv3Tm4ghA=";
      };
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-08-09";

      src = prevAttrs.src.override {
        tag = null;
        rev = "216ffb4581af2075bf7a9f975219c375767cae15";
        hash = "sha256-9OVgsiOxVOgLl8iJZS/khqTCExY5KWj5+VQ8niU0c0c=";

        leaveDotGit = false;
        postFetch = ''
          echo 216ffb4581af2075bf7a9f975219c375767cae15 > $out/COMMIT
        '';
      };

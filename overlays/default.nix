{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-09";
      src = prevAttrs.src.override {
        tag = null;
        rev = "b34eba2fb3ca6878a62ac7cbe67aaefd6cadbe0c";
        hash = "sha256-Rx+BAfL7vdOwQK/MRn+qZr0jMKdmfESfGNX8TNMcvtw=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-09";

      src = prevAttrs.src.override {
        tag = null;
        rev = "ac61f4aee2159b4ca06ecc72218a0c20216cda35";
        hash = "sha256-GrrV+67K+uvad7z19YdefZl1Ft153yfIb7AnWK1+sBM=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "eda360f8daed8dd0436143405c532384a708f86d";
          hash = "sha256-0qOummXzqLFNT6I/DhP4Z7dkELXpBdNJa1SpekqhYwU=";
          fetchSubmodules = false;

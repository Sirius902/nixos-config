{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-06-29";
      src = prevAttrs.src.override {
        tag = null;
        rev = "635aac8ff301fd0430acd92526a1e171e3a80c90";
        hash = "sha256-hcTcqAgVbFlJ0xTcLCtmJZ33Wv/VL/Kkk+NeuCIIPM0=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-06-29";

      src = prevAttrs.src.override {
        tag = null;
        rev = "c581ce89a92de895cab3f4ce4da9b7b909b4656d";
        hash = "sha256-+gqfgQ2MpbT06wBks2xNUTUauHhGGosF5a0zz0unglg=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "360cc86677d1487fdadb78539c18fbd464d40f54";
        hash = "sha256-0WpAzsbjVAlRGseMSimt6unuv4b6F2bdSScqbzdneSU=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-06-28";

      src = prevAttrs.src.override {
        tag = null;
        rev = "e2ab15aa23fd05f5f90f71552ee33857bad5775e";
        hash = "sha256-hhFbwD1YGBr2twgKqGvwGOT06Rb5ji+Jc2lP5KqYw4I=";

        leaveDotGit = false;
        postFetch = ''
          echo e2ab15aa23fd05f5f90f71552ee33857bad5775e > $out/COMMIT
        '';
      };

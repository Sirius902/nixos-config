{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-06";
      src = prevAttrs.src.override {
        tag = null;
        rev = "ac30feeddb4d53f08397897574649228b8c187d1";
        hash = "sha256-4KRGaZYTFo50tfaNBrIgEKJi1whMAWn/Uy39Uq7XwSM=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-03-05";

      src = prevAttrs.src.override {
        tag = null;
        rev = "89e74828e63680e211f36bd5ec600f2bf4be7552";
        hash = "sha256-7dZkXLjYuODEFVq5reNJmzyCkDFcrny0zhjzgmNl98M=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "034d58e17f1667863d32cf38cec172a4b19b7abe";
          hash = "sha256-4arQdsT84LcOb5n9o21/HchR46vbu2j8c3MxD0zMM6M=";
        };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-20";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2ba7756c0e2cbba363844104142515c02749cd58";
        hash = "sha256-ZeacrHWXMFxjO5VPYWAJtJxQtFFi9PgntqbwJswUYng=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-19";

      src = prevAttrs.src.override {
        tag = null;
        rev = "0c3fac6ce0a3edf16f6b5d78add8eb06969a04d1";
        hash = "sha256-SDL1MwtA9YYFXv1gzS7ukbxujdlELjEc4oBA8cg0yRE=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "0743ad57e4b6c27d056791ac66a6db111908c663";

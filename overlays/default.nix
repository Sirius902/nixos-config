{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-03-01";
      src = prevAttrs.src.override {
        tag = null;
        rev = "00a1c7278a90d85e5b2e1eb551b9ff80d858b21c";
        hash = "sha256-038sG6iQ1SzoaX119cwx8Jt/ZpM/fmScFKhwNxs1AC8=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-03-01";

      src = prevAttrs.src.override {
        tag = null;
        rev = "dbf23a66afaa3040fb8abcebb2c2d9f8873a8c61";
        hash = "sha256-NNTRUrcfv2lg9VtZYDfEtplhPn6UhL/bTvNTrg1bUz0=";
      };
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "135727a56aceef55f7038f1197f862a394a05196";
          hash = "sha256-NVFMStJ6DIsnxD4Zamc6e7D9tPyS3DKQiQFo4+Wf5uU=";
        };

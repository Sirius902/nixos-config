{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-23";
      src = prevAttrs.src.override {
        tag = null;
        rev = "7a90d09cfe3c31bf95c3cb63c6301c5c0824c531";
        hash = "sha256-D84KueRK1Jre+3Yw2UMlHrsHWGCAkbewb+m2qA0yZoA=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-23";

      src = prevAttrs.src.override {
        tag = null;
        rev = "3730a53a53a31be266da1aeaa89908c4f8f1ef29";
        hash = "sha256-rUgSG12EdyH2OuLND3R5sGxRijd+NE5FwacDgg7CGR0=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-23";

      src = prevAttrs.src.override {
        tag = null;
        rev = "e2013caea0abc4224ccf5152a7de11c0d7bf3dbe";
        hash = "sha256-u4bSfvjVtCzj+TdyrMxe1DtpCJFQOFZlZpGMbvn6Atg=";

        leaveDotGit = false;
        postFetch = ''
          echo e2013caea0abc4224ccf5152a7de11c0d7bf3dbe > $out/COMMIT
        '';
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-01-31";
      src = prevAttrs.src.override {
        tag = null;
        rev = "1c08439907753a86ee1628f07d5fcbe86bfdda2f";
        hash = "sha256-ROzkiU2HcSp/w2vdu5UUANCD+Uwmw4l0YTUfMyK11/k=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "3bd6a0f9f80e264e4ebbe54bfdc6a3b9ba0137e2";
        hash = "sha256-uTGsnVbZCZ+vetsGQPnxx9LReiG7zVVza3S/p75hlmw=";
      };

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-19";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2613d7eee7de144e80b7c2e866a4c3dd8ad24f33";
        hash = "sha256-qpSPOY5Jf9HgvvnHCcfkG7EYFOoY+jDGVtpz1j0fGQQ=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-20";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f95edd27e0dde1ea26e94152ac3c6c12ed42ffaf";
        hash = "sha256-HdyYp+AlETzybmf2+sv/UszMgpTvnr7zZ1K3PauZP7g=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "d467eae0a484b88dcbc1a19c35e8ab9292f93896";
          hash = "sha256-W05G4tD1qGQ/zybRH9PsYPXc0XWtRozDGFFTVjP3JW4=";
          fetchSubmodules = false;

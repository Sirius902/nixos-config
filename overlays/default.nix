{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-04-24";
      src = prevAttrs.src.override {
        tag = null;
        rev = "e1734b51c3e24e60403e46efaf47fe143a3add62";
        hash = "sha256-Ie8JrH7pPHaXv44IihDmiUDeDZ7YahjwrjzfH8IkgtE=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-04-23";

      src = prevAttrs.src.override {
        tag = null;
        rev = "e455a2f41af3aef36390b5030cdfb46e7c595440";
        hash = "sha256-cUp/IuX5/K4g/jSuiCxBMRHm0Xis/tiOvC4LqToiPw0=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "7aea3285948953fced55a2321a911c358a0c3cfd";
          hash = "sha256-7U9BQ64LecV4ZGEKZNqMV700LMIMX7q72NUrbxslJu0=";
          fetchSubmodules = false;

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.39-unstable-2026-02-06";
      src = prevAttrs.src.override {
        tag = null;
        rev = "93dbdead24e1474a94c59fffc1f6cfb25abe488b";
        hash = "sha256-XoY51jwhGZwD+/9JKVQgX+9phHsrdC0JxQkhJ2fQ6xg=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.14.0-unstable-2026-02-07";

      src = prevAttrs.src.override {
        tag = null;
        rev = "2e789649ecc34373238a31e8388b14ffccd46db8";
        hash = "sha256-x/2hXcXqgJ+OXewbH6Acqv94MhD5lo5J2KKmMML37E0=";
      };

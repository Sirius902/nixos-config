{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-02";
      src = prevAttrs.src.override {
        tag = null;
        rev = "dc06cac01499e1ade65011237a53f3eea0fc8343";
        hash = "sha256-I8CY47kO4hOEUpGK8nWmbZ7DQud8IOo7aDeLcUcQgTo=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-02";

      src = prevAttrs.src.override {
        tag = null;
        rev = "0a51093d28eb68ab6acdc752cda48a6eeab9c846";
        hash = "sha256-Vwzgyyxt0eEwQFjJdoMXMudE7hUSMKxLrCF8UV6QxZw=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "c7097df9676d7961baa6071e11a2af0be9683c11";
        hash = "sha256-gHbtXtBWGW6lkxdmyAC7h0NscrU1vR8lr0l8Y8w79G8=";

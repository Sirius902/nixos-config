{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "0fcb15ab1810926ac0b3ffdbcc38ed01eadbf861";
        hash = "sha256-MISrVVTv6QSN/B8dKmDK3vsSZlBOBZWr6HZ+QjRWA68=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.16.0-unstable-2026-07-18";

      src = prevAttrs.src.override {
        tag = null;
        rev = "4c916f7850cdf5ab375c05a5981e032e926bda9b";
        hash = "sha256-ld2JCbORng5drbkWLdNTyDiCImvrF17lEi/+AW1vHVI=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-18";

      src = prevAttrs.src.override {
        tag = null;
        rev = "415ec4de182034179143231e84c17dbcdf8be8aa";
        hash = "sha256-b+6YBxt0Qtg7BvMRMdkPd3M45CNO3mFqJ00WgvKC4ZM=";

        leaveDotGit = false;
        postFetch = ''
          echo 415ec4de182034179143231e84c17dbcdf8be8aa > $out/COMMIT
        '';
      };

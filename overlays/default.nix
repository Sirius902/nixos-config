{inputs}: [
  ...
  in {
    rpcs3 = (prev.rpcs3.override {inherit glew;}).overrideAttrs (prevAttrs: {
      version = "0.0.41-unstable-2026-07-22";
      src = prevAttrs.src.override {
        tag = null;
        rev = "8604f1c5d83fbd256e3e29fdccee4ead805c2689";
        hash = "sha256-li5ozqMHw61fxy44FzgbHIlN52bt4XZtb4cAAoCdMUs=";
      };
  ...
  in {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        ...
        hash = "sha256-FvnZWyBboy3qxU4CyzwdJi+150Y9tZD6zBAwax5pvg0=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2603a-unstable-2026-07-22";

      src = prevAttrs.src.override {
        tag = null;
        rev = "03e409a3e10d67287b81c7c937657b6d2a0c39a0";
        hash = "sha256-75uDUhYcQUMehS8MpOM7c21MAg7TGtaTTt4f+pfylok=";

        leaveDotGit = false;
        postFetch = ''
          echo 03e409a3e10d67287b81c7c937657b6d2a0c39a0 > $out/COMMIT
        '';
      };

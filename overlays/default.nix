{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-03-23";
      src = prevAttrs.src.override {
        tag = null;
        rev = "2bcc27d581875025610f6f0ad4b34053cd5a470b";
        hash = "sha256-WWGBpHIFVvGpGBWRHRsqkgaESOxmOJVu52arsPiy4mM=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-03-23";

      src = prevAttrs.src.override {
        tag = null;
        rev = "f450405f3538fc1ded91a8b36e470eee62cfde9c";
        hash = "sha256-qDtVLR0xoyRWmAlBkA4J7qcszsYLbxP3myTMIK+wT6s=";
      };

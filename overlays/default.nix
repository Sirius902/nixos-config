{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-26";
      src = prevAttrs.src.override {
        tag = null;
        rev = "a87d175295cc33df2264939c5437ed3b3f6790e1";
        hash = "sha256-Ih69YzkPMn+QEa8mq2WF2pwQXwUbj3Igc103AFOtC04=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-26";

      src = prevAttrs.src.override {
        tag = null;
        rev = "78053e70b7d9f7835603265d4a64fe2307ff9a98";
        hash = "sha256-S1RNTVc2kJr71BeIOPO/LME5Qp/PosDi/IRmmSUkUeM=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "26721d0157728828a1d9257efee61e82bcf0b75e";
          hash = "sha256-pCuFuDNdBHJARNSm831+GAmchFiriu7KaEOQjpnz89U=";
          fetchSubmodules = false;

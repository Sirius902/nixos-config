{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.40-unstable-2026-05-16";
      src = prevAttrs.src.override {
        tag = null;
        rev = "61a2604824b01382bf57651b85f87b811306c2de";
        hash = "sha256-2ODLCeA3VK6uQznhW0kKYMmovOEJ26TSt0/8GG8HXEk=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-17";

      src = prevAttrs.src.override {
        tag = null;
        rev = "94786d70cacb76c241516e27241121f50963cfa6";
        hash = "sha256-o37WboS0elCsiufysj6/06qRg+e/j1RVFE6YYXjRwuE=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "527acc4abd0271142d06f1c38f424ce4c8777139";
          hash = "sha256-XbpcmhvahEspUmKKcf/31BH3FIoW36sX23ikzBHS8G0=";
          fetchSubmodules = false;

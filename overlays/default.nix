{inputs}: [
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (prevAttrs: {
      version = "0.15.0-unstable-2026-05-19";

      src = prevAttrs.src.override {
        tag = null;
        rev = "7572c51c0ea194575e4fdaf204993371d503a90f";
        hash = "sha256-VAeYHH47V0s1LaxZQpbBUHpSvYxXC+MUvV8yNJ4FWGI=";
  ...
  (
    final: prev: {
      shadps4-qt = prev.shadps4-qt.overrideAttrs (prevAttrs: {
        ...
        src = prevAttrs.src.override {
          tag = null;
          rev = "9f322c5f54792867fb37120d8e349004cb91a127";
          hash = "sha256-8JFm4qH9Akd3H+8d6nVRFHNL+I3/vymUJI8GUN/eLa0=";
          fetchSubmodules = false;

{inputs}: [
  ...
  (final: prev: {
    rpcs3 = prev.rpcs3.overrideAttrs (prevAttrs: {
      version = "0.0.42-unstable-2026-08-31";
      src = prevAttrs.src.override {
        tag = null;
        rev = "a99fde6f5b252b144a4edbe37317f8b8e20e8b6e";
        hash = "sha256-eYgjBcNMEZglnnvkfCK6cJHjBNV73kNSwoiU/EnPzmQ=";
      };
  ...
  (final: prev: {
    shadps4 = prev.shadps4.overrideAttrs (finalAttrs: prevAttrs: {
      version = "0.18.0-unstable-2026-08-31";

      src = prevAttrs.src.override {
        tag = null;
        rev = "e29cf7199663b0dd45079b661b0be3e32f83cb4b";
        hash = "sha256-ZHdFMPLrRselMrM3gA82Nsd3neE8S7ZBlta83/22HrU=";
    ...
    shadps4-qtlauncher = prev.shadps4-qtlauncher.overrideAttrs (finalAttrs: prevAttrs: {
      ...
      src = prevAttrs.src.override {
        tag = null;
        rev = "bcebdf7d53eaff384d62bfef169a4e98ce284390";
        hash = "sha256-eJsTiLeZUcg8os+nOLYIL63OR3BuFsYbLasijZS8aRE=";
  ...
  (final: prev: {
    dolphin-emu = prev.dolphin-emu.overrideAttrs (prevAttrs: {
      version = "2606a-unstable-2026-08-30";

      src = prevAttrs.src.override {
        tag = null;
        rev = "1fd7f3521895f285aa9382af8e7e464991437225";
        hash = "sha256-Xf/6qB4IsCVMwY3DwnzZTLLO8Yc2onOLImGtEPHHS9c=";

        leaveDotGit = false;
        postFetch = ''
          echo 1fd7f3521895f285aa9382af8e7e464991437225 > $out/COMMIT
        '';
      };
